...
\begin{quote}
    \textit{Det må være fysisk \textit{kontakt} mellom det utstrakte og noe annet utstrakt }
\end{quote}
...
\begin{flushleft}
    Descartes sier at man må holde ideene adskilt for å forklare denne virkningen, for å få kunnskap om det. Han mener at man derfor ikke kan legge på så strenge premiss som Elisabeth gjør, og viser til at det finnes kausal virkning mellom tenkende substans og utstrakt substans, nemlig mellom en stein med vekt og jordas sentrum. 
\end{flushleft}
